...
<?php
	...
	if(isset($_POST["searchButton"]))
	{
		echo "<h2 class='bg-info text-center'>";
			echo "Branch Wise Top 10 Borrowed Books";
		echo "</h2>";
		
		if(isset($_POST["searchButton"]))	
		$groupByQuery = "select bk.title, l.l_name, count(b.book_id) as noOfTimesBorrowed from branch l, borrow b, book bk where b.lib_id='". $_POST["lID"] ."' and l.lib_id = b.lib_id and b.book_id = bk.book_id group by b.book_id limit 10;";
		$headingArray = array("Book Name", "Branch Name", "No Of Times Borrowed");
